 ...
 */
function percySnapshot(page, name, options) {
    if (options === void 0) { options = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var err_1, domSnapshot;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/];
                case 4: return [4 /*yield*/, isAgentRunning()];
                case 5:
                    if (!(_a.sent())) {
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, page.evaluate(function (name, options) {
                            var percyAgentClient = new PercyAgent({ handleAgentCommunication: false });
                            return percyAgentClient.snapshot(name, options);
                        }, name, options)];
                case 6:
                    domSnapshot = _a.sent();
                    return [4 /*yield*/, postDomSnapshot(name, domSnapshot, page.url(), options)];
                case 7:
                    _a.sent();
                    return [2 /*return*/];
            }
